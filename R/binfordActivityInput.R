#' @name binfordActivityInput
#' @title An example input file for \code{binfordActivity}
#' @description This dataset demonstrates the required input format for \code{binfordActivity}.
