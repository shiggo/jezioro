#' @name vwhoQuinlan2010
#' @title The Dipteran-Volume Weighted Hypolimnetic Oxygen (VWHO) Calibration Set from Quinlan and Smol 2010
#' @description \code{vwhoQuinlan2010} is a 54x47 data frame containing the VWHO concentrations and sedimentary midge (chironomid and chaoborid) assemblage data for the 54 lake south-central Ontario calibration set described in Quinlan and Smol (2001, 2010).
#' 
...
#'   }
#' @docType data
#' @usage vwhoQuinlan2010
#' @format A data frame containing 54 observations of 47 variables.
NULL
"vwhoQuinlan2010"
