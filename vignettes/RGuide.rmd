...
## Age-Depth Modelling
### Gamma Dating
At PEARL, we currently use [ScienTissiME](http://www.scientissime.net/) to produce ^210^Pb chronologies. However, when reanalyzing cores dated prior to 2012-2013, they have been dated with the binford functions provided by the `jezioro` package.
