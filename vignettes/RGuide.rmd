...
GAMs can be constructed using the `mgcv` package.

Simpson (In Review)^[Simpson GL (In Review) Modelling palaeoecological time series using generalized additive models.] (https://www.biorxiv.org/content/10.1101/322248v1) provides a detailed introduction to use of GAMs along with the annotated R code (in the supplementary info) to produce the described analyses described.
