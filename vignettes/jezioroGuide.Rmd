...
- `dipteranVWHO`: harmonize appropriately formatted chironomid/chaoborid count data with the Quinlan and Smol (2001, 2010) calibration set, construct their VWHO inference model, infer VWHO from the sample data, and perform an analog matching analysis between the sample data and the calibration set
...
In addition, the `chirInfo` dataset tabulates several aspects of chironomid taxonomy/ecology into a single file to facilitate manipulation of chironomid data (i.e. sorting by littoral vs profundal etc.)
<br>
<br>
