...
- the 'binford' functions (`binfordRho`, `binfordActivity`, `binfordDates`) collectively calculate ^210^Pb dates for a sediment core using the methods described in Binford 1990, Schelske 1994, and Appleby 2001.
